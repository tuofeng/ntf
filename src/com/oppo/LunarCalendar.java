...
//        System.out.println(Arrays.toString(solarToLunar(2020, 4, 29)));

        //设置要转换的阳历日期
        Calendarist calendarist = Calendarist.fromSolar(2023, 2, 23);
        ...
        System.out.println(calendarist.toLunar());
